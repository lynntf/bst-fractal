...
between the first and second axes. Orthogonal axes use $\gamma = 90^\circ$.
...
The line thickness is $\varepsilon$ for some measurements on the exceptional
 ...
 * For a $1\,000 \times 1\,000$ grid, this is 15.6 MB
 * For a $2\,000 \times 2\,000$ grid, this is 62.5 MB
 * For a $4\,000 \times 4\,000$ grid, this is 250.0 MB
